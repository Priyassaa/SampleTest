...
public class BaseClass {
	...
	public static void excelRead(String sheetName, int rowNum, int cellNum) throws IOException {
		...
		if (cellType == 1) {
			...
			//Date dd = c.getCellValue("dd-MM-yyyy");
	...
	public static void createNewExcelFile(int rowNum, int cellNum, String writeData) throws IOException {
		File f = new File("C:\\Users\\SASI\\eclipse-workspace\\MavenProject\\Excel\\newfile.xlsx");
	...
	public static void excelWrite(String[] args) throws IOException {
		File f = new File("C:\\Users\\SASI\\eclipse-workspace\\MavenProject\\Excel\\newfile.xlsx");
		Workbook w = new XSSFWorkbook();
		Sheet s = w.createSheet("Datas");
		Row r = s.createRow(0);
		Cell c = r.createCell(0);
		c.setCellValue("Priyasri");
		FileOutputStream fos = new FileOutputStream(f);
		w.write(fos);
